...
//     axios
//       .post(
//         `https://pricehunter-production.up.railway.app/predict_price/`,
//         values
//       )
//       .then((res) => {
//         console.log(res);
...
//         <Navbar />
//         <h1
//           className="font-myfont text-center  font-medium text-white
...
//         <div
//           className=" mx-auto  p-16   min-h-[600px] rounded-xl shadow-2xl"
//           style={{
//             width: "100%",
//             maxWidth: "32.5rem",
...
//           }}
//         >
//           <h2 className="text-3xl font-bold  text-white">Price Prdicion</h2>
...
//                   onChange={formik.handleChange}
//                   onBlur={formik.handleBlur}
//                   className="peer block py-2.5 px-0 w-full text-xl text-[] bg-transparent border-0 border-b-[1px] border-[#1E1E1E] appearance-none  focus:outline-none "
//                 />
//                 <label
//                   htmlFor="color"
...
//                 {"You wrote something wrong... Try to fix it: " +
//                   ApiError.split(" ").slice(-1).join(" ")}
//               </p>
//             ) : (
//               <>
//                 <p className="text-xl text-green-700 font-bold">
//                   The predicted price: {price} $
//                 </p>
...
export default function RecentProduct() {
  ...
  function submitfun(values) {
    ...
    axios
      .post(
        `https://pricehunter-production-dabc.up.railway.app/predict_price/`,
        values
      )
      .then((res) => {
        console.log(res);
        setloading(false); // وقف الـ loading فور استقبال الرد
        const rawPrice = res.data.predicted_price;
        const resProductUrls = res.data.product_urls;
        const err = res.data.error;
                        ...
                        {productUrls.amazon && (
                          <div>
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="px-8 py-2 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 inline-block"
                            >
                              Amazon
                            </a>
                          </div>
